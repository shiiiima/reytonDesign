                        ...
                        if (t >= f)
                            this._locked || ((this._totalTime = f), (this._cycle = this._repeat)),
                                this._reversed ||
                                    ...
                                    0 === this._duration && (0 === t || 0 > y || y === r) && y !== t && this._first && ((_ = !0), y > r && (h = "onReverseComplete"))),
                                (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r),
                            ...
                            if (
                                ...
                                (this._time = 0),
                                (0 !== m || (0 === p && y !== r && (y > 0 || (0 > t && y >= 0)) && !this._locked)) && ((h = "onReverseComplete"), (n = this._reversed)),
                                0 > t)
                            )
                        ...
                        "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
                        {
                            parser: function (t, e, i, s, n, o, l) {
                                ...
                                var h,
                                    ...
                                    k = "transformOrigin";
                                if (
                                    (l.display ? ((c = Q(t, "display")), (T.display = "block"), (h = Ne(t, r, !0, l.parseTransform)), (T.display = c)) : (h = Ne(t, r, !0, l.parseTransform)),
                                    (s._transform = h),
                                    ...
                                    : ((c = Q(t, a, r) + ""),
                                      ...
                                      "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || (d && P.test(f))
                                          ...
                                          ? ((h = parseFloat(c)),
                                            ...
                                            ("" === c || "auto" === c) &&
                                                ("width" === a || "height" === a ? ((h = ie(t, a, r)), (p = "px")) : "left" === a || "top" === a ? ((h = H(t, a, r)), (p = "px")) : ((h = "opacity" !== a ? 0 : 1), (p = ""))),
                                            (g = d && "=" === f.charAt(1)),
